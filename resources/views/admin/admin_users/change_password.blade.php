...
<section class="content">
    <div class="box">
        <div class="box-body">
            <?php echo Form::open(array('id' => 'change_password_form', 'class' => 'form-horizontal', 'url' => '/admin/users/change_password', 'method' => 'post')); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <center>
                        <a href="<?php echo url('/admin/dashboard'); ?>" class="btn btn-sm btn-danger">Cancel</a>
